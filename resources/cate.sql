...
CREATE TABLE `food` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=297 DEFAULT CHARSET=utf8 COMMENT='食物表';
...
INSERT INTO `hibernate_sequence` VALUES (321),(321);
